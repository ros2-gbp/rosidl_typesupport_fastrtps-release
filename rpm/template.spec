...
Requires:       ros-iron-rosidl-typesupport-fastrtps-cpp
...
Provides:       ros-iron-rosidl-typesupport-c-packages(member)
...
%if 0%{?with_weak_deps}
Supplements:    ros-iron-rosidl-typesupport-c-packages(all)
%endif
